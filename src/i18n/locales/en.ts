export default {
  ...
  modals: {
    ...
    advancedReset: {
      ...
      profilesDesc:
        "Deletes all custom profiles and pinned snapshots. (Keeps built-in profiles).",
      snippetsLabel: "Global & Profile Snippets",
      snippetsDesc:
        "Deletes all CSS snippets, both global and inside all profiles.",
      ...
      settingsDesc:
        "Resets language, FPS, layout, and other options to default.",
  ...
  notices: {
    ...
    langCodeExists: (code: string) =>
      `A custom language with the code "${code}" already exists.`,
    langNameExists: (name: string) =>
      `A custom language with the name "${name}" already exists.`,
    ...
    langImported: (name: string) =>
      `Successfully imported translations from ${name}`,
    langCopiedJson: "Copied translations JSON to clipboard.",
    langPastedJson: (count: number) =>
      `Successfully applied ${count} translations.`,
    ...
    deleteBackgroundsError: (message: string) =>
      `Failed to delete backgrounds folder: ${message}`,
